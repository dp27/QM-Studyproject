...
p.line.months <- grid.arrange(p.line.april.amu,p.line.may.amu,p.line.june.amu,p.line.july.amu,p.line.august.amu,p.line.september.amu, nrow = 2, top = "Amudarya Kerki")
plot(p.line.months)
